...
const controls = [
  // ── AC: Access Controls ────────────────────────────────────────────────────
  {
    id: "AC-01", category: "Access Controls",
  ...
  {
    id: "AC-02", category: "Access Controls",
  ...
  {
    id: "AC-03", category: "Access Controls",
  ...
  {
    id: "AC-04", category: "Access Controls",
  ...
  // ── CM: Change Management ──────────────────────────────────────────────────
  {
    id: "CM-01", category: "Change Management",
    ...
    check() {
      ...
      return { pass: migrationCount >= 1 && hasConfig, evidence, confidence: migrationCount >= 3 ? 90 : 70 };
    },
  },
  {
    id: "CM-02", category: "Change Management",
  ...
  {
    id: "CM-03", category: "Change Management",
  ...
  // ── OPS: IT Operations ─────────────────────────────────────────────────────
  {
    id: "OPS-01", category: "IT Operations",
    ...
    check() {
      ...
      return { pass: hasAuditPort && hasCorrelation, evidence, confidence: hasPeriodAudit ? 90 : 70 };
    },
  },
  {
    id: "OPS-02", category: "IT Operations",
    ...
    check() {
      ...
      const hasEventTypes = fc(`${FIN}/domain/events.ts`, "FinanceEventType") ||
  ...
  {
    id: "OPS-03", category: "IT Operations",
    ...
    check() {
      ...
      return { pass: hasPort && (hasDb || hasSchema), evidence, confidence: hasDb && hasSchema ? 95 : 70 };
    },
  },

  // ── DI: Data Integrity ─────────────────────────────────────────────────────
  {
    id: "DI-01", category: "Data Integrity",
  ...
  {
    id: "DI-02", category: "Data Integrity",
...
if (JSON_MODE) {
  ...
  console.log(`  ${"ID".padEnd(8)} ${"Category".padEnd(20)} ${"Description".padEnd(48)} ${"Status".padEnd(6)} Conf`);
  ...
  for (const r of results) {
    ...
    console.log(`  ${r.id.padEnd(8)} ${r.category.padEnd(20)} ${r.description.padEnd(48)} ${icon} ${r.status.padEnd(6)} ${r.confidence}%`);
  }
