...
const FINANCE = join(ROOT, "packages/modules/finance/src");
...
function fileContains(filePath, pattern) {
  ...
  try { return readFileSync(abs, "utf-8").includes(pattern); } catch { return false; }
}
...
function dirContains(dirPath, pattern) {
  ...
  try {
    for (const entry of readdirSync(abs, { withFileTypes: true })) {
      ...
      if (entry.isDirectory()) { if (dirContains(full, pattern)) return true; }
      else if (entry.isFile() && /\.(ts|sql)$/.test(entry.name)) { if (fileContains(full, pattern)) return true; }
    }
    return false;
  } catch { return false; }
}

function fe(p) { return existsSync(join(ROOT, p)); }
function fc(p, pat) { return fileContains(join(ROOT, p), pat); }
function te(name) { return existsSync(join(TESTS, name)); }
...
const checks = [
  ...
  {
    id: "INF-01", desc: "Tenant isolation",
    check() {
      ...
      return {
        pass: hasRls, confidence: hasTest && hasSpoofTest ? 95 : hasRls ? 70 : 0, evidence,
        hasPort: true, hasType: true, hasTest: hasTest || hasSpoofTest, hasDbConstraint: hasRls, hasRuntime: false
      };
    },
  },
  {
    id: "INF-02", desc: "Company boundary",
    check() {
      ...
      return {
        pass: hasEntity, confidence: hasEntity && hasPort ? 80 : 50, evidence,
        hasPort, hasType: hasEntity, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "INF-03", desc: "Ledger boundary",
    check() {
      ...
      return {
        pass: hasEntity && hasPort, confidence: 80, evidence,
        hasPort, hasType: hasEntity, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "INF-04", desc: "Fiscal period governance",
    check() {
      ...
      return {
        pass: hasGate && hasPort, confidence: hasTest ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "INF-05", desc: "Idempotency & exactly-once",
    check() {
      ...
      return {
        pass: hasPort && hasService, confidence: hasTest && hasDb ? 95 : 70, evidence,
        hasPort, hasType: true, hasTest: hasTest || hasPropTest, hasDbConstraint: hasDb, hasRuntime: false
      };
    },
  },
  {
    id: "INF-06", desc: "Audit trail completeness",
    check() {
      ...
      return {
        pass: hasPort && hasCorrelation, confidence: hasReason ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "INF-07", desc: "Immutability of posted facts",
    check() {
      ...
      return {
        pass: hasService, confidence: hasDbTrigger && hasPropTest ? 95 : 70, evidence,
        hasPort: false, hasType: true, hasTest: hasPropTest, hasDbConstraint: hasDbTrigger, hasRuntime: false
      };
    },
  },
  ...
  {
    id: "GL-01", desc: "Chart of Accounts hierarchy",
    check() {
      ...
      return {
        pass: hasCalc && hasPort, confidence: 80, evidence,
        hasPort, hasType: true, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-02", desc: "Journal entry creation",
    check() {
      ...
      return {
        pass: hasService, confidence: hasTest ? 90 : 70, evidence,
        hasPort: true, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-03", desc: "Double-entry balancing",
    check() {
      ...
      return {
        pass: hasCalc && hasService, confidence: hasPropTest ? 98 : hasTest ? 90 : 70, evidence,
        hasPort: false, hasType: true, hasTest: hasTest || hasPropTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-04", desc: "Minimum double-entry structure",
    check() {
      ...
      return {
        pass: hasCheck, confidence: hasPropTest ? 98 : 80, evidence,
        hasPort: false, hasType: true, hasTest: hasPropTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-05", desc: "Posting workflow (draft → posted)",
    check() {
      ...
      return {
        pass: hasService, confidence: hasTest && hasAtomicity ? 95 : hasTest ? 85 : 70, evidence,
        hasPort: true, hasType: true, hasTest: hasTest || hasAtomicity, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-06", desc: "Reversal (posted correction)",
    check() {
      ...
      return {
        pass: hasService, confidence: hasTest && hasPropTest ? 95 : hasTest ? 85 : 70, evidence,
        hasPort: true, hasType: true, hasTest: hasTest || hasPropTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-07", desc: "Void / cancel (draft-only)",
    check() {
  ...
  {
    id: "GL-08", desc: "Trial balance generation",
    check() {
      ...
      return {
        pass: hasCalc, confidence: hasTest ? 90 : 70, evidence,
        hasPort: true, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-09", desc: "Account classification (reporting)",
    check() {
      ...
      return {
        pass: hasCalc || hasPort, confidence: hasTest ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-10", desc: "Period close controls",
    check() {
      ...
      if (hasTest) evidence.push("close-period/lock-period tests");
      return {
        pass: hasClose && hasLock, confidence: hasTest ? 90 : 70, evidence,
        hasPort: true, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-11", desc: "Budget baseline + variance",
    check() {
      ...
      return {
        pass: hasPort && hasService, confidence: hasTest ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "GL-12", desc: "Audit-grade lifecycle trail",
    check() {
      const hasPort = fe(`${FIN}/app/ports/journal-audit-repo.ts`);
      ...
      if (hasCorrelation) evidence.push("post-journal.ts: correlationId");
      return {
        pass: hasPort && hasCorrelation, confidence: hasPeriodAudit ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  ...
  {
    id: "FX-01", desc: "Multi-currency line support",
    check() {
      ...
      if (hasPropTest) evidence.push("invariants-pure.property.test.ts: FX-01 deterministic conversion");
      return {
        pass: hasField && hasConvert, confidence: hasPropTest ? 95 : 80, evidence,
        hasPort: true, hasType: true, hasTest: hasPropTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "FX-02", desc: "Rate sourcing & effective dating",
    check() {
      ...
      return {
        pass: hasPort && hasLookup, confidence: 80, evidence,
        hasPort, hasType: true, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "FX-03", desc: "Triangulation / cross rates",
    check() {
      ...
      return {
        pass: hasCalc, confidence: hasTest ? 90 : 70, evidence,
        hasPort: false, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "FX-04", desc: "Revaluation & unrealized gain/loss",
    check() {
      ...
      return {
        pass: hasGainLoss, confidence: 75, evidence,
        hasPort: false, hasType: true, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "FX-05", desc: "Translation & CTA",
    check() {
  ...
  {
    id: "IC-01", desc: "Agreement governance",
    check() {
      ...
      return {
        pass: hasPort, confidence: hasTest ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "IC-02", desc: "Paired entries (mirror journals)",
    check() {
  ...
  {
    id: "IC-03", desc: "Elimination readiness",
    check() {
  ...
  {
    id: "IC-04", desc: "Settlement tracking",
    check() {
      ...
      return {
        pass: hasPort, confidence: hasTest ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest: hasTest || hasAging, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  ...
  {
    id: "AH-04", desc: "Revenue recognition schedules",
    check() {
      ...
      return {
        pass: hasPort && hasMilestones, confidence: hasTest ? 90 : 70, evidence,
        hasPort, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  ...
  {
    id: "RE-01", desc: "Recurring journal templates",
    check() {
  ...
  {
    id: "RE-02", desc: "Idempotent batch execution",
    check() {
      const hasDedup = fc(`${FIN}/app/services/process-recurring-journals.ts`, "nextRunDate");
      const hasAdvance = fc(`${FIN}/app/services/process-recurring-journals.ts`, "updateNextRunDate");
      const hasTest = te("process-recurring-journals.test.ts");
      const evidence = [];
      if (hasDedup) evidence.push("process-recurring-journals.ts: nextRunDate dedup guard");
      if (hasAdvance) evidence.push("process-recurring-journals.ts: updateNextRunDate advances schedule");
      if (hasTest) evidence.push("process-recurring-journals.test.ts");
      return {
        pass: hasDedup && hasAdvance, confidence: hasTest ? 85 : 65, evidence,
        hasPort: true, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "RE-03", desc: "Recurring schedule audit trail",
    check() {
      ...
      return {
        pass: hasOutbox || hasAudit, confidence: 70, evidence,
        hasPort: false, hasType: true, hasTest: false, hasDbConstraint: false, hasRuntime: hasOutbox
      };
    },
  },
  ...
  {
    id: "FR-01", desc: "Balance Sheet generation",
    check() {
  ...
  {
    id: "FR-02", desc: "Income Statement generation",
    check() {
  ...
  {
    id: "FR-03", desc: "Cash Flow Statement generation",
    check() {
      ...
      return {
        pass: hasService || hasCalc, confidence: hasTest ? 90 : 70, evidence,
        hasPort: true, hasType: true, hasTest, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "FR-04", desc: "Report parameterization & scoping",
    check() {
      ...
      return {
        pass: hasRoutes && hasSchemas, confidence: 85, evidence,
        hasPort: false, hasType: true, hasTest: false, hasDbConstraint: false, hasRuntime: false
      };
    },
  },
  {
    id: "FR-05", desc: "Comparative period support",
    check() {
      const hasCalc = fe(`${FIN}/domain/calculators/comparative-report.ts`) || fe(`${FIN}/domain/calculators/comparative-reports.ts`);
  ...
  {
    id: "FR-06", desc: "Budget variance reporting",
    check() {
      const hasService = fe(`${FIN}/app/services/get-budget-variance.ts`);
...
if (JSON_MODE) {
  ...
  console.log(`  ${'ID'.padEnd(8)} ${'Description'.padEnd(42)} ${'Status'.padEnd(6)} ${'Lvl'.padEnd(4)} Confidence`);
  console.log("  " + "\u2500".repeat(85));

  for (const r of results) {
    const icon = r.status === "PASS" ? "\u2705" : "\u274C";
    console.log(`  ${r.id.padEnd(8)} ${r.description.padEnd(42)} ${icon} ${r.status.padEnd(6)} ${r.evidenceLevel.padEnd(4)} ${r.confidence}%`);
  }
