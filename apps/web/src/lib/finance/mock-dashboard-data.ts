/**
 * Mock Data Providers for Finance Dashboard Charts
 * 
 * TODO: Replace with real API calls once dashboard endpoint is implemented
 */
...
export function getMockRatiosData(): RatioGaugeData[] {
  return [
    ...
    },
    {
      ...
      unit: 'ratio',
      definition: '(Current Assets - Inventory) ÷ Current Liabilities. More conservative liquidity measure.',
    },
    {
      metricId: 'fin.ar.dso',
      label: 'DSO',
  ...
  return [
    {
      ...
      book: 'GAAP',
      children: [
        { name: 'Production Line A', value: 1500000, category: 'Equipment', location: 'HQ', book: 'GAAP' },
        { name: 'Forklift Fleet', value: 500000, category: 'Equipment', location: 'Warehouse', book: 'GAAP' },
    ...
    },
    {
      ...
      book: 'GAAP',
      children: [
        { name: 'Sales Fleet', value: 600000, category: 'Vehicles', location: 'Various', book: 'GAAP' },
        { name: 'Executive Cars', value: 200000, category: 'Vehicles', location: 'HQ', book: 'GAAP' },
      ],
    },
    {
      name: 'Buildings',
