  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader>
        ...
        <PageHeaderDescription>Review and approve pending financial documents. Items are sorted by SLA urgency.</PageHeaderDescription>
      </PageHeader>
      ...
      <Tabs defaultValue={status} className="space-y-4">
        ...
        <TabsContent value={status}>
          <ApprovalsTable items={items} pagination={{ page, totalPages, searchParams: { status, documentType, slaStatus } }} />
        </TabsContent>
      </Tabs>
    </div>
  );
