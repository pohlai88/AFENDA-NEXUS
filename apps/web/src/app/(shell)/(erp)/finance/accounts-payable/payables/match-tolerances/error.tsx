...
export default function MatchTolerancesError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Match tolerances page error:', error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[var(--page-min-h)] flex-col items-center justify-center gap-4">
      ...
      <h2 className="text-lg font-semibold">Failed to load match tolerances</h2>
