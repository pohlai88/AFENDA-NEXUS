...
import {
  ...
  pricingMethodLabels,
} from '@/features/finance/transfer-pricing/types';
  ...
  return (
    <div className="grid gap-4 md:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-green-600">{s.complianceRate}%</div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <Button asChild>
          <Link href={routes.finance.transferPricingNew}>
