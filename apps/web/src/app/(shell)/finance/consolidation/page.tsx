...
import {
  getGroupEntities,
  getGoodwillAllocations,
  getConsolidationSummary,
} from '@/features/finance/consolidation/queries/consolidation.queries';
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {entity.entityType !== 'parent' && (
              <Badge variant="secondary">{entityTypeLabels[entity.entityType]}</Badge>
            )}
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="outline" asChild>
            <Link href={routes.finance.consolidationRun}>Run Consolidation</Link>
          </Button>
          <Button asChild>
            <Link href={routes.finance.consolidationEntityNew}>
