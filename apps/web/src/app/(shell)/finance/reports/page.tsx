...
const reportCategories: ReportCategory[] = [
  {
    ...
    reports: [
      ...
      },
      {
        ...
        description: 'Changes in shareholders equity over a period',
  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        description: 'Intercompany balances by entity',
    ...
    reports: [
      {
        ...
        description: 'Complete fixed asset listing with depreciation',
    ...
    reports: [
      {
        ...
        description: 'Cost distribution across cost centers',
