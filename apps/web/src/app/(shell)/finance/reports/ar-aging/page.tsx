...
interface ARAgingBucket { customer: string; customerId: string; current: number; days30: number; days60: number; days90: number; over90: number; total: number; creditLimit: number; }

async function getARAgingData(): Promise<{ buckets: ARAgingBucket[]; totals: Omit<ARAgingBucket, 'customer' | 'customerId' | 'creditLimit'>; currency: string }> {
  await new Promise((r) => setTimeout(r, 400));
  const buckets: ARAgingBucket[] = [
    { customer: 'ABC Corporation', customerId: 'cust-1', current: 125000, days30: 45000, days60: 0, days90: 0, over90: 0, total: 170000, creditLimit: 500000 },
    { customer: 'XYZ Industries', customerId: 'cust-2', current: 85000, days30: 65000, days60: 55000, days90: 25000, over90: 15000, total: 245000, creditLimit: 250000 },
    { customer: 'Global Trading LLC', customerId: 'cust-3', current: 320000, days30: 80000, days60: 50000, days90: 0, over90: 0, total: 450000, creditLimit: 1000000 },
    { customer: 'Tech Solutions Inc', customerId: 'cust-4', current: 95000, days30: 0, days60: 0, days90: 0, over90: 0, total: 95000, creditLimit: 200000 },
  ];
