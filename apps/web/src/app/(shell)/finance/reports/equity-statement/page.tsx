...
async function getEquityStatementData(): Promise<{
  ...
  return {
    ...
    movements: [
      ...
      },
      {
        ...
        treasuryShares: 0,
        otherMovements: 0,
        closingBalance: 26500000,
      },
      {
        component: 'Retained Earnings',
        openingBalance: 45000000,
        comprehensiveIncome: 8500000,
        dividends: -3000000,
        shareIssues: 0,
        treasuryShares: 0,
        otherMovements: 0,
      ...
      {
        component: 'OCI - FX Translation',
        openingBalance: -1200000,
        comprehensiveIncome: -350000,
        dividends: 0,
        shareIssues: 0,
        treasuryShares: 0,
        otherMovements: 0,
      ...
      {
        component: 'OCI - Cash Flow Hedges',
        openingBalance: 185000,
        comprehensiveIncome: 45000,
        dividends: 0,
        shareIssues: 0,
        treasuryShares: 0,
        otherMovements: -25000,
        closingBalance: 205000,
      },
      {
        component: 'Treasury Shares',
