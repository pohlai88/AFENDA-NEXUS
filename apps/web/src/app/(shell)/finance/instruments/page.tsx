  ...
  return (
    <div className="grid gap-4 md:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div
            className={`text-2xl font-bold ${s.unrealizedGainLoss >= 0 ? 'text-green-600' : 'text-red-600'}`}
          >
        ...
        <div className="mt-4 grid grid-cols-3 gap-4 text-sm">
          <div>
            ...
            <div className="text-xs text-muted-foreground">
              {fairValueLevelLabels[instrument.fairValueLevel]}
            </div>
          </div>
          <div>
            <span className="text-muted-foreground">Unrealized G/L</span>
            <div className={`font-mono ${gainLossColor}`}>
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <Button asChild>
          <Link href={routes.finance.instrumentNew}>
