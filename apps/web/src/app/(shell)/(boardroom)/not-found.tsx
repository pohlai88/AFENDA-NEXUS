...
export default function BoardroomNotFound() {
  return (
    <main className="flex page-min-h flex-col items-center justify-center px-4 text-center">
      ...
      <p className="mt-1 max-w-sm text-sm text-muted-foreground">
        The boardroom page you&apos;re looking for doesn&apos;t exist or has been moved.
      </p>
      <Button asChild className="mt-6">
        <Link href={routes.boardroom.dashboard}>Back to Boardroom</Link>
      </Button>
    </main>
  );
}
