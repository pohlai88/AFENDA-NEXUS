...
import type { RemittanceAdviceView } from '../queries/ap-payment-run.queries';

interface ApRemittanceViewProps {
  remittance: RemittanceAdviceView;
}

export function ApRemittanceView({ remittance }: ApRemittanceViewProps) {
  return (
