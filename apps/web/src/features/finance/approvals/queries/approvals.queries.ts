...
const mockPolicies: ApprovalPolicy[] = [
  {
    ...
    thresholds: [
      { minAmount: 0, maxAmount: 5000, approverRoles: ['finance_analyst'], requiresAllApprovers: false },
      { minAmount: 5000, maxAmount: 25000, approverRoles: ['finance_manager'], requiresAllApprovers: false },
      { minAmount: 25000, maxAmount: null, approverRoles: ['finance_director', 'cfo'], requiresAllApprovers: true },
    ],
    slaHours: 24,
  ...
  },
  {
    ...
    thresholds: [
      { minAmount: 0, maxAmount: 500, approverRoles: ['line_manager'], requiresAllApprovers: false },
      { minAmount: 500, maxAmount: 5000, approverRoles: ['department_head'], requiresAllApprovers: false },
      { minAmount: 5000, maxAmount: null, approverRoles: ['finance_director'], requiresAllApprovers: false },
    ],
    slaHours: 24,
    escalationEnabled: true,
    escalationHours: 72,
