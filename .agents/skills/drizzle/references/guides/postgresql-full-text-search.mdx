...
<Prerequisites>
  ...
  [Indexes](/docs/indexes-constraints#indexes) - [sql operator](/docs/sql) - You should have
...
export const posts = pgTable(
  ...
  (table) => [index('title_search_index').using('gin', sql`to_tsvector('english', ${table.title})`)]
);
