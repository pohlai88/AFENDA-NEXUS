...
<Prerequisites>
  ...
  [read here](https://tsx.is/) - Turso Database - [website](https://docs.turso.tech/introduction) -
  Turso Database driver - [website](https://docs.turso.tech/connect/javascript) &
  [GitHub](https://github.com/tursodatabase/turso/tree/main/bindings/javascript)
</Prerequisites>
...
<Npm>drizzle-orm@beta @tursodatabase/database dotenv -D drizzle-kit@beta tsx</Npm>
...
<Callout type="info" title="important">
  ...
  purposes, you can use this example: ```plaintext copy DB_FILE_NAME=mydb.sqlite ```
</Callout>
