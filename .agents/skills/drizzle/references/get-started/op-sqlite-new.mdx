...
<Prerequisites>
  - **OP-SQLite** - SQLite library for react-native - [read
  here](https://github.com/OP-Engineering/op-sqlite)
</Prerequisites>
...
<Npm>drizzle-orm @op-engineering/op-sqlite -D drizzle-kit</Npm>
