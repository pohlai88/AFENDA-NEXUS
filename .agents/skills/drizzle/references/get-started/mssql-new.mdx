...
<Prerequisites>
  ...
  [read here](https://tsx.is/) - **node-mssql** - package for querying your MSSQL database - [read
  here](https://github.com/tediousjs/node-mssql)
</Prerequisites>
...
<Npm>drizzle-orm@beta mssql dotenv -D drizzle-kit@beta tsx</Npm>
