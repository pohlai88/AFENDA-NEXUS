...
<Prerequisites>
  - Database [connection basics](/docs/connect-overview) with Drizzle - node-mssql
  [basics](https://github.com/tediousjs/node-mssql)
</Prerequisites>
...
<Npm>drizzle-orm@beta mssql -D drizzle-kit@beta</Npm>
