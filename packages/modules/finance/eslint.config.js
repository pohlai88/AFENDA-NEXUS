  ...
  ...baseConfig,
  {
    ...
    rules: {
      ...
      "no-restricted-syntax": [
        ...
        {
          selector: "TSAsExpression[typeAnnotation.type='TSTypeReference'][typeAnnotation.typeName.name='Record'] > MemberExpression[object.property.name='query']",
          message:
            "CIG-03: Do not cast req.query as Record<string, string> — use a Zod schema .parse() for type-safe input validation.",
        },
        {
          selector: "TSAsExpression[typeAnnotation.type='TSTypeLiteral'] > MemberExpression[object.property.name='query']",
          message:
            "CIG-03: Do not cast req.query with inline type — use a Zod schema .parse() for type-safe input validation.",
        },
        {
          selector: "TSAsExpression[typeAnnotation.type='TSTypeLiteral'] > MemberExpression[object.property.name='params']",
          message:
