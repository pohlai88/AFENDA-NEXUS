...
import { enforceExpensePolicy, type PolicyCheckLine } from "../slices/expense/calculators/policy-enforcement.js";
...
describe("enforceExpensePolicy", () => {
  it("passes compliant lines", () => {
    const lines: PolicyCheckLine[] = [
      { lineNumber: 1, category: "TRAVEL", amount: 30000n, currencyCode: "USD", hasReceipt: true, description: "Flight" },
    ];
  ...
  it("flags amount exceeding per-item limit", () => {
    const lines: PolicyCheckLine[] = [
      { lineNumber: 1, category: "TRAVEL", amount: 60000n, currencyCode: "USD", hasReceipt: true, description: "Expensive flight" },
    ];
    const policies = [makePolicy()];
    const result = enforceExpensePolicy(lines, policies, "USD");
  ...
  it("flags missing receipt when required", () => {
    const lines: PolicyCheckLine[] = [
      { lineNumber: 1, category: "TRAVEL", amount: 20000n, currencyCode: "USD", hasReceipt: false, description: "Taxi" },
    ];
    const policies = [makePolicy()];
    const result = enforceExpensePolicy(lines, policies, "USD");
    expect(result.isCompliant).toBe(false);
  ...
  it("flags claim total exceeding limit", () => {
    const lines: PolicyCheckLine[] = [
      { lineNumber: 1, category: "TRAVEL", amount: 50000n, currencyCode: "USD", hasReceipt: true, description: "Flight 1" },
      { lineNumber: 2, category: "TRAVEL", amount: 50000n, currencyCode: "USD", hasReceipt: true, description: "Flight 2" },
      { lineNumber: 3, category: "TRAVEL", amount: 50000n, currencyCode: "USD", hasReceipt: true, description: "Flight 3" },
      { lineNumber: 4, category: "TRAVEL", amount: 50000n, currencyCode: "USD", hasReceipt: true, description: "Flight 4" },
      { lineNumber: 5, category: "TRAVEL", amount: 50000n, currencyCode: "USD", hasReceipt: true, description: "Flight 5" },
    ];
    const policies = [makePolicy()];
    const result = enforceExpensePolicy(lines, policies, "USD");
  ...
  it("skips categories without policy", () => {
    const lines: PolicyCheckLine[] = [
      { lineNumber: 1, category: "ENTERTAINMENT", amount: 999999n, currencyCode: "USD", hasReceipt: false, description: "Party" },
    ];
