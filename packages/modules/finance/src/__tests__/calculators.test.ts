...
describe("computeTrialBalance", () => {
  it("computes balanced trial balance", () => {
    const result = computeTrialBalance(
      [
        { accountCode: "1000", accountName: "Cash", accountType: "ASSET", debitTotal: money(10000n, "USD"), creditTotal: money(0n, "USD") },
        { accountCode: "2000", accountName: "AP", accountType: "LIABILITY", debitTotal: money(0n, "USD"), creditTotal: money(10000n, "USD") },
      ],
      "USD",
    );
  ...
  it("detects unbalanced trial balance", () => {
    const result = computeTrialBalance(
      [
        { accountCode: "1000", accountName: "Cash", accountType: "ASSET", debitTotal: money(10000n, "USD"), creditTotal: money(0n, "USD") },
        { accountCode: "2000", accountName: "AP", accountType: "LIABILITY", debitTotal: money(0n, "USD"), creditTotal: money(5000n, "USD") },
      ],
      "USD",
    );
...
describe("classifyByAccountType", () => {
  it("classifies rows by account type", () => {
    const rows = [
      { accountCode: "1000", accountName: "Cash", accountType: "ASSET" as const, debitTotal: money(10000n, "USD"), creditTotal: money(0n, "USD"), netBalance: money(10000n, "USD") },
      { accountCode: "2000", accountName: "AP", accountType: "LIABILITY" as const, debitTotal: money(0n, "USD"), creditTotal: money(5000n, "USD"), netBalance: money(-5000n, "USD") },
      { accountCode: "3000", accountName: "Equity", accountType: "EQUITY" as const, debitTotal: money(0n, "USD"), creditTotal: money(3000n, "USD"), netBalance: money(-3000n, "USD") },
      { accountCode: "4000", accountName: "Revenue", accountType: "REVENUE" as const, debitTotal: money(0n, "USD"), creditTotal: money(1000n, "USD"), netBalance: money(-1000n, "USD") },
      { accountCode: "5000", accountName: "Expense", accountType: "EXPENSE" as const, debitTotal: money(500n, "USD"), creditTotal: money(0n, "USD"), netBalance: money(500n, "USD") },
    ];
...
describe("classifyBalanceSheet", () => {
  it("classifies by account type instead of charAt(0)", () => {
    const rows = [
      { accountCode: "1000", accountName: "Cash", accountType: "ASSET" as const, netBalance: 10000n },
      { accountCode: "2000", accountName: "AP", accountType: "LIABILITY" as const, netBalance: -5000n },
      { accountCode: "3000", accountName: "Equity", accountType: "EQUITY" as const, netBalance: -5000n },
      { accountCode: "4000", accountName: "Revenue", accountType: "REVENUE" as const, netBalance: -1000n },
    ];
  ...
  it("works with non-standard account codes", () => {
    ...
    const rows = [
      { accountCode: "9999", accountName: "Special Asset", accountType: "ASSET" as const, netBalance: 5000n },
      { accountCode: "8888", accountName: "Special Liability", accountType: "LIABILITY" as const, netBalance: -5000n },
    ];
...
describe("classifyIncomeStatement", () => {
  it("classifies revenue and expenses by account type", () => {
    const rows = [
      { accountCode: "4000", accountName: "Sales", accountType: "REVENUE" as const, netBalance: -50000n },
      { accountCode: "5000", accountName: "COGS", accountType: "EXPENSE" as const, netBalance: 30000n },
      { accountCode: "1000", accountName: "Cash", accountType: "ASSET" as const, netBalance: 20000n },
    ];
...
describe("classifyCashFlow", () => {
  it("classifies by account type and excludes cash accounts", () => {
    const rows = [
      { accountCode: "1000", accountName: "Cash", accountType: "ASSET" as const, netBalance: 5000n },
      { accountCode: "1200", accountName: "Equipment", accountType: "ASSET" as const, netBalance: 10000n },
      { accountCode: "2000", accountName: "AP", accountType: "LIABILITY" as const, netBalance: -3000n },
      { accountCode: "4000", accountName: "Revenue", accountType: "REVENUE" as const, netBalance: -8000n },
      { accountCode: "5000", accountName: "Expense", accountType: "EXPENSE" as const, netBalance: 6000n },
    ];
