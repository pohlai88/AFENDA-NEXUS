...
describe("deriveCashFlowIndirect", () => {
  const baseMovements: TrialBalanceMovement[] = [
    { accountId: "cash", accountCode: "1000", accountName: "Cash", accountType: "ASSET", accountSubType: "cash", openingBalanceMinor: 50000n, closingBalanceMinor: 65000n, currency: "USD" },
    { accountId: "ar", accountCode: "1100", accountName: "Accounts Receivable", accountType: "ASSET", accountSubType: "receivable", openingBalanceMinor: 20000n, closingBalanceMinor: 25000n, currency: "USD" },
    { accountId: "inv", accountCode: "1200", accountName: "Inventory", accountType: "ASSET", accountSubType: "inventory", openingBalanceMinor: 30000n, closingBalanceMinor: 28000n, currency: "USD" },
    { accountId: "equip", accountCode: "1500", accountName: "Equipment", accountType: "ASSET", accountSubType: "fixed_asset", openingBalanceMinor: 100000n, closingBalanceMinor: 120000n, currency: "USD" },
    { accountId: "ap", accountCode: "2000", accountName: "Accounts Payable", accountType: "LIABILITY", accountSubType: "payable", openingBalanceMinor: 15000n, closingBalanceMinor: 18000n, currency: "USD" },
    { accountId: "debt", accountCode: "2500", accountName: "Long Term Debt", accountType: "LIABILITY", accountSubType: "long_term_debt", openingBalanceMinor: 50000n, closingBalanceMinor: 40000n, currency: "USD" },
    { accountId: "rev", accountCode: "4000", accountName: "Revenue", accountType: "REVENUE", accountSubType: "revenue", openingBalanceMinor: 0n, closingBalanceMinor: 80000n, currency: "USD" },
    { accountId: "cogs", accountCode: "5000", accountName: "Cost of Sales", accountType: "EXPENSE", accountSubType: "cost_of_sales", openingBalanceMinor: 0n, closingBalanceMinor: 40000n, currency: "USD" },
    { accountId: "depr", accountCode: "6100", accountName: "Depreciation", accountType: "EXPENSE", accountSubType: "depreciation", openingBalanceMinor: 0n, closingBalanceMinor: 10000n, currency: "USD" },
    { accountId: "opex", accountCode: "6000", accountName: "Operating Expenses", accountType: "EXPENSE", accountSubType: "operating_expense", openingBalanceMinor: 0n, closingBalanceMinor: 15000n, currency: "USD" },
  ];
...
describe("auditRateSources", () => {
  ...
  it("detects duplicate pairs", () => {
    const rates: RateEntry[] = [
      { fromCurrency: "USD", toCurrency: "EUR", rate: 0.92, rateDate: "2025-12-31", source: "ECB" },
      { fromCurrency: "USD", toCurrency: "EUR", rate: 0.93, rateDate: "2025-12-31", source: "Reuters" },
    ];
    const result = auditRateSources(rates, "2025-12-31");
...
describe("computeAccruals", () => {
  it("computes straight-line accrual for a full period", () => {
    const schedules: AccrualSchedule[] = [
      {
        id: "s1", type: "prepaid_expense", method: "straight_line",
        sourceAccountId: "prepaid", targetAccountId: "expense",
        totalAmountMinor: 12000n, recognizedToDateMinor: 0n,
        startDate: "2025-01-01", endDate: "2025-12-31",
        currency: "USD", description: "Annual insurance",
      },
    ];
  ...
  it("caps recognition at remaining amount", () => {
    const schedules: AccrualSchedule[] = [
      {
        id: "s1", type: "accrued_revenue", method: "straight_line",
        sourceAccountId: "receivable", targetAccountId: "revenue",
        totalAmountMinor: 1000n, recognizedToDateMinor: 990n,
        startDate: "2025-01-01", endDate: "2025-12-31",
        currency: "USD", description: "Service contract",
      },
    ];
    ...
    const schedules: AccrualSchedule[] = [
      {
        id: "s1", type: "prepaid_expense", method: "straight_line",
        sourceAccountId: "prepaid", targetAccountId: "expense",
        totalAmountMinor: 12000n, recognizedToDateMinor: 12000n,
        startDate: "2025-01-01", endDate: "2025-12-31",
        currency: "USD", description: "Fully recognized",
      },
    ];
    const result = computeAccruals(schedules, "2025-06-01", "2025-06-30");
    ...
    const schedules: AccrualSchedule[] = [
      {
        ...
        currency: "USD", description: "Future insurance",
      },
    ];
    const result = computeAccruals(schedules, "2025-01-01", "2025-01-31");
    expect(result.result.entries).toHaveLength(0);
  ...
  it("handles milestone-based accrual", () => {
    const schedules: AccrualSchedule[] = [
      {
        id: "s1", type: "deferred_revenue", method: "milestone",
        sourceAccountId: "deferred", targetAccountId: "revenue",
        totalAmountMinor: 100000n, recognizedToDateMinor: 0n,
        startDate: "2025-01-01", endDate: "2025-12-31",
        currency: "USD", description: "Project milestone",
        milestonePercent: 25,
      },
    ];
  ...
  it("handles accrued expense type", () => {
    const schedules: AccrualSchedule[] = [
      {
        id: "s1", type: "accrued_expense", method: "straight_line",
        sourceAccountId: "accrued_liab", targetAccountId: "expense",
        totalAmountMinor: 6000n, recognizedToDateMinor: 0n,
        startDate: "2025-01-01", endDate: "2025-06-30",
        currency: "USD", description: "Accrued utilities",
      },
    ];
    const result = computeAccruals(schedules, "2025-01-01", "2025-01-31");
    expect(result.result.entries[0].debitAccountId).toBe("expense");
    ...
    const schedules: AccrualSchedule[] = [
      {
        ...
        totalAmountMinor: 0n, recognizedToDateMinor: 0n,
        startDate: "2025-01-01", endDate: "2025-12-31",
        currency: "USD", description: "Bad",
      },
    ];
