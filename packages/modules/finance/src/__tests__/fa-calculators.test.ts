...
import { computeDepreciation, computeBatchDepreciation } from "../slices/fixed-assets/calculators/depreciation.js";
...
describe("computeBatchDepreciation", () => {
  it("processes multiple assets", () => {
    const results = computeBatchDepreciation([
      { assetId: "a1", acquisitionCost: 120000n, residualValue: 0n, usefulLifeMonths: 120, depreciationMethod: "STRAIGHT_LINE", accumulatedDepreciation: 0n, periodMonths: 1 },
      { assetId: "a2", acquisitionCost: 60000n, residualValue: 0n, usefulLifeMonths: 60, depreciationMethod: "STRAIGHT_LINE", accumulatedDepreciation: 0n, periodMonths: 1 },
    ]);
...
describe("splitAssetComponents", () => {
  it("validates components sum to total cost", () => {
    const result = splitAssetComponents({
      ...
      totalCost: 100000n,
      components: [
        { name: "Engine", costPortion: 60000n, residualValue: 5000n, usefulLifeMonths: 120, depreciationMethod: "STRAIGHT_LINE" },
        { name: "Body", costPortion: 40000n, residualValue: 2000n, usefulLifeMonths: 180, depreciationMethod: "STRAIGHT_LINE" },
      ],
    });
  ...
  it("detects unallocated amount", () => {
    const result = splitAssetComponents({
      ...
      totalCost: 100000n,
      components: [
        { name: "Engine", costPortion: 50000n, residualValue: 0n, usefulLifeMonths: 120, depreciationMethod: "STRAIGHT_LINE" },
      ],
    });
  ...
  it("detects residual exceeding cost", () => {
    const result = splitAssetComponents({
      ...
      totalCost: 100000n,
      components: [
        { name: "Engine", costPortion: 100000n, residualValue: 200000n, usefulLifeMonths: 120, depreciationMethod: "STRAIGHT_LINE" },
      ],
    });
    expect(result.isValid).toBe(false);
