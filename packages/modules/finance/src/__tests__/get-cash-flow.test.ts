...
function mockBalanceRepo(rows: Array<{ accountCode: string; accountName: string; accountType: AccountType; debit: bigint; credit: bigint }>) {
  return {
...
describe("getCashFlow", () => {
  it("classifies revenue/expense as operating activities", async () => {
    const balanceRepo = mockBalanceRepo([
      { accountCode: "4000", accountName: "Revenue", accountType: "REVENUE" as const, debit: 0n, credit: 5000n },
      { accountCode: "5000", accountName: "COGS", accountType: "EXPENSE" as const, debit: 2000n, credit: 0n },
    ]);
  ...
  it("classifies non-cash assets as investing activities", async () => {
    const balanceRepo = mockBalanceRepo([
      { accountCode: "1100", accountName: "Accounts Receivable", accountType: "ASSET" as const, debit: 3000n, credit: 0n },
    ]);
  ...
  it("classifies liabilities/equity as financing activities", async () => {
    const balanceRepo = mockBalanceRepo([
      { accountCode: "2000", accountName: "Accounts Payable", accountType: "LIABILITY" as const, debit: 0n, credit: 4000n },
      { accountCode: "3000", accountName: "Retained Earnings", accountType: "EQUITY" as const, debit: 0n, credit: 1000n },
    ]);
  ...
  it("excludes cash account (1000) from all categories", async () => {
    const balanceRepo = mockBalanceRepo([
      { accountCode: "1000", accountName: "Cash", accountType: "ASSET" as const, debit: 10000n, credit: 0n },
      { accountCode: "4000", accountName: "Revenue", accountType: "REVENUE" as const, debit: 0n, credit: 10000n },
    ]);
  ...
  it("computes correct netCashFlow across all categories", async () => {
    const balanceRepo = mockBalanceRepo([
      { accountCode: "4000", accountName: "Revenue", accountType: "REVENUE" as const, debit: 0n, credit: 10000n },
      { accountCode: "5000", accountName: "Expenses", accountType: "EXPENSE" as const, debit: 3000n, credit: 0n },
      { accountCode: "1100", accountName: "AR", accountType: "ASSET" as const, debit: 2000n, credit: 0n },
      { accountCode: "2000", accountName: "AP", accountType: "LIABILITY" as const, debit: 0n, credit: 1000n },
    ]);
