...
function makeClosedPeriods() {
  return [
    makePeriod({
      ...
      name: '2025-P01',
      status: 'CLOSED',
      range: dateRange(new Date('2025-01-01'), new Date('2025-01-31')),
    }),
    makePeriod({
      id: PERIOD_IDS.p02,
      name: '2025-P02',
      status: 'CLOSED',
      range: dateRange(new Date('2025-02-01'), new Date('2025-02-28')),
    }),
    makePeriod({
      id: PERIOD_IDS.p03,
      name: '2025-P03',
      status: 'CLOSED',
      range: dateRange(new Date('2025-03-01'), new Date('2025-03-31')),
    }),
  ];
}
...
function makeTbRows(): TrialBalanceRow[] {
  return [
    ...
    },
    {
      ...
      accountType: 'REVENUE',
      debitTotal: money(0n, 'USD'),
      creditTotal: money(80000n, 'USD'),
    },
    {
      accountCode: '5000',
      accountName: 'COGS',
      accountType: 'EXPENSE',
      debitTotal: money(25000n, 'USD'),
      creditTotal: money(0n, 'USD'),
    },
    {
      accountCode: '6000',
