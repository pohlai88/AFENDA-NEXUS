...
describe("computeArAging", () => {
  ...
  it("groups by customer", () => {
    const inv1 = makeArInvoice({ id: "i1", customerId: "c1", dueDate: new Date("2025-04-01"), status: "POSTED" });
    const inv2 = makeArInvoice({ id: "i2", customerId: "c2", dueDate: new Date("2025-04-01"), status: "POSTED" });
...
describe("computeLateFee", () => {
  ...
  it("computeLateFees handles batch", () => {
    const results = computeLateFees([
      { invoiceId: "a", outstandingAmount: 100000n, dueDate: new Date("2025-01-01"), asOfDate: new Date("2025-04-01"), annualRatePercent: 12 },
      { invoiceId: "b", outstandingAmount: 50000n, dueDate: new Date("2025-05-01"), asOfDate: new Date("2025-04-01"), annualRatePercent: 12 },
    ]);
...
describe("computeDunningScore", () => {
  ...
  it("computeDunningScores filters nulls", () => {
    const results = computeDunningScores([
      { customerId: "c1", invoiceId: "i1", outstandingAmount: 100000n, dueDate: new Date("2025-04-01"), asOfDate: new Date("2025-04-15"), previousDunningLevel: null },
      { customerId: "c1", invoiceId: "i2", outstandingAmount: 50000n, dueDate: new Date("2025-05-01"), asOfDate: new Date("2025-04-15"), previousDunningLevel: null },
    ]);
...
describe("computeEclProvision", () => {
  ...
  it("returns zero provision for zero balances", () => {
    const result = computeEclProvision({
      current: 0n, days30: 0n, days60: 0n, days90: 0n, over90: 0n,
    });
  ...
  it("over90 bucket has highest provision rate", () => {
    const result = computeEclProvision({
      current: 100000n, days30: 100000n, days60: 100000n, days90: 100000n, over90: 100000n,
    });
