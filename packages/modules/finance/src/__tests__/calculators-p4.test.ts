...
describe('derivePostings', () => {
  const rules: DerivationRule[] = [
    {
      id: 'r1',
      name: 'COGS from Sales',
      type: 'posting',
      sourceAccountId: 'sales',
      targetAccountId: 'cogs',
      percentage: 60,
      isActive: true,
      priority: 1,
    },
...
describe('allocateByDriver', () => {
  ...
  it('handles single driver', () => {
    const drivers: AllocationDriver[] = [{ targetAccountId: 'sole', weight: 100 }];
