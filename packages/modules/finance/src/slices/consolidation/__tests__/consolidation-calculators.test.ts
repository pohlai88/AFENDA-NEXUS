...
describe('generateConsolidationJournal', () => {
  it('generates lines from all adjustment types', () => {
    const result = generateConsolidationJournal({
      ...
      goodwillEntries: [{ entityId: 'sub-a', goodwillAmount: 180000n, currencyCode: 'USD' }],
      dividendEliminations: [{ entityId: 'sub-a', eliminationAmount: 75000n, currencyCode: 'USD' }],
  ...
  it('skips zero-amount entries', () => {
    const result = generateConsolidationJournal({
      ...
      goodwillEntries: [{ entityId: 'sub-a', goodwillAmount: 0n, currencyCode: 'USD' }],
      dividendEliminations: [{ entityId: 'sub-a', eliminationAmount: 0n, currencyCode: 'USD' }],
      nciEquityAccountId: 'nci-eq',
      nciPnlAccountId: 'nci-pnl',
      goodwillAccountId: 'gw-acc',
      investmentAccountId: 'inv-acc',
