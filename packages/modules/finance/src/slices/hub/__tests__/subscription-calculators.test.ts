...
describe("computeUsageCharge", () => {
  ...
  it("throws on empty tiers", () => {
    expect(() =>
      computeUsageCharge({
        subscriptionId: "s", metricName: "m", usageQuantity: 100n,
        includedAllowance: 0n, tiers: [], currencyCode: "USD",
      }),
  ...
  it("throws on negative usage", () => {
    expect(() =>
      computeUsageCharge({
        subscriptionId: "s", metricName: "m", usageQuantity: -1n,
        includedAllowance: 0n, tiers: [{ fromUnits: 0n, toUnits: null, pricePerUnit: 1n }],
        currencyCode: "USD",
      }),
...
describe("computeChurnMrr", () => {
  it("computes MRR movements", () => {
    const result = computeChurnMrr({
      events: [
        { subscriptionId: "s1", eventType: "NEW", amount: 5000n, currencyCode: "USD", eventDate: "2025-01-05" },
        { subscriptionId: "s2", eventType: "EXPANSION", amount: 2000n, currencyCode: "USD", eventDate: "2025-01-10" },
        { subscriptionId: "s3", eventType: "CHURN", amount: 3000n, currencyCode: "USD", eventDate: "2025-01-15" },
        { subscriptionId: "s4", eventType: "CONTRACTION", amount: 1000n, currencyCode: "USD", eventDate: "2025-01-20" },
      ],
  ...
  it("computes churn rates", () => {
    const result = computeChurnMrr({
      events: [
        { subscriptionId: "s1", eventType: "CHURN", amount: 5000n, currencyCode: "USD", eventDate: "2025-01-15" },
      ],
      periodStart: "2025-01-01",
      periodEnd: "2025-01-31",
      openingMrr: 100000n,
  ...
  it("handles zero opening MRR", () => {
    const result = computeChurnMrr({
      events: [
        { subscriptionId: "s1", eventType: "NEW", amount: 1000n, currencyCode: "USD", eventDate: "2025-01-01" },
      ],
      periodStart: "2025-01-01",
      periodEnd: "2025-01-31",
      openingMrr: 0n,
  ...
  it("handles reactivation events", () => {
    const result = computeChurnMrr({
      events: [
        { subscriptionId: "s1", eventType: "REACTIVATION", amount: 3000n, currencyCode: "USD", eventDate: "2025-01-10" },
      ],
      periodStart: "2025-01-01",
      periodEnd: "2025-01-31",
      openingMrr: 50000n,
  ...
  it("throws on negative opening MRR", () => {
    expect(() =>
      computeChurnMrr({
        events: [], periodStart: "2025-01-01", periodEnd: "2025-01-31",
        openingMrr: -1n, currencyCode: "USD",
      }),
