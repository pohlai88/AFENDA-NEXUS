...
export interface FinanceDeps extends GlDeps, FxDeps, IcDeps, HubDeps, ApDeps, ArDeps, TaxDeps, FaDeps, BankDeps, CreditDeps, ExpenseDeps, ProjectDeps, LeaseDeps, ProvisionDeps, TreasuryDeps, CostAccountingDeps, ConsolidationDeps, FinInstrumentsDeps, HedgeDeps, IntangiblesDeps, DeferredTaxDeps, TransferPricingDeps, SharedDeps { }

export type { GlDeps, FxDeps, IcDeps, HubDeps, ApDeps, ArDeps, TaxDeps, FaDeps, BankDeps, CreditDeps, ExpenseDeps, ProjectDeps, LeaseDeps, ProvisionDeps, TreasuryDeps, CostAccountingDeps, ConsolidationDeps, FinInstrumentsDeps, HedgeDeps, IntangiblesDeps, DeferredTaxDeps, TransferPricingDeps, SharedDeps };
