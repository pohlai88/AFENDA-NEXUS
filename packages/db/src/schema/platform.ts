...
export const tenants = platformSchema
  .table(
    'tenant',
    {
      ...pkId(),
...
export const companies = platformSchema
  .table(
    'company',
    {
      ...pkId(),
...
export const users = platformSchema
  .table(
    'user',
    {
      ...pkId(),
...
export const userPreferences = platformSchema
...
export const systemConfig = platformSchema
  .table('system_config', {
...
export const adminUsers = platformSchema
  .table('admin_user', {
    userId: uuid('user_id').primaryKey(),
...
export const adminActionLogs = platformSchema
  .table(
    'admin_action_log',
    {
      ...pkId(),
...
export const seedRun = platformSchema
  .table(
    'seed_run',
    {
      id: uuid('id')
    ...
    (table) => [
      uniqueIndex('uq_seed_run_key_branch_tenant').on(
        table.seedKey,
        table.branchName,
        table.tenantId
      ),
      index('idx_seed_run_branch').on(table.branchName),
      index('idx_seed_run_tenant')
        .on(table.tenantId)
